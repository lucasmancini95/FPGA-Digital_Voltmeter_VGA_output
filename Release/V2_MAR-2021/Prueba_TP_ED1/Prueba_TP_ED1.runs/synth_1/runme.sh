...
HD_PWD='C:/Users/manci/OneDrive/Escritorio/Prueba_TP_ED1/Prueba_TP_ED1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Voltimetro_toplevel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Voltimetro_toplevel.tcl
