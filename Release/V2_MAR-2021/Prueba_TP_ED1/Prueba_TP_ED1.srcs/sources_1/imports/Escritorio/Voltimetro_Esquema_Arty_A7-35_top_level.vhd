...
entity Voltimetro_toplevel is
	...
	attribute loc 			of led_2    : signal is "E1";					-- salida color verde (led rgb)
	attribute iostandard 	of led_2   : signal is "LVCMOS33";
...
--	 Generador del reloj lento
	...
	inst_voltimetro: Voltmeter_top
		port map(
            enable          => '1',
            clock			=> clk25MHz,
            reset			=> rst_i,
            signal_in	=> data_volt_in_i,
            signal_out => data_volt_out_o,
            H_sync			=> hs_o,
            V_sync			=> vs_o,
            R			=> red_o,
            G			=> grn_o,
