...
HD_PWD='C:/Users/manci/OneDrive/Escritorio/Prueba_TP_ED1/Prueba_TP_ED1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Voltimetro_toplevel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Voltimetro_toplevel.tcl -notrace
